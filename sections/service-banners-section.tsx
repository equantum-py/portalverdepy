            ...
            >
              {desktopImage ? (
                <picture>
                  ...
                  <Image src={desktopImage} alt={banner.title || 'Servicio de Portal Verde'} fill quality={90} sizes="(max-width: 639px) 88vw, 50vw" className="object-contain sm:object-cover sm:transition sm:duration-500 sm:group-hover:scale-[1.02]" />
                </picture>
              ) : null}
            </a>
          );

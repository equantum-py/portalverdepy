        ...
        <Box title="Portada principal">
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            <HeroImageUploader
              ...
              recommendation="Tamaño recomendado: 1920 × 650 px"
            ...
            <HeroImageUploader
              label="Imagen Mobile"
              recommendation="Tamaño recomendado: 750 × 507 px"
          ...
          <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Desactivá esta opción para mostrar solamente la imagen.
            </p>
          ...
          >
            ...
            {values.heroEnabled ? (
              ...
              <p className="p-8 text-center text-sm text-slate-500">
                La portada principal está oculta.
              </p>
            )}
          </div>
        </Box>
